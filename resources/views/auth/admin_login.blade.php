...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>SarveshWajs Admin Login</title>
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    <span class="red">SarveshWajs Management</span>
                                    <span class="white" id="id-text2">System</span>
                                </h1>
                                <h4 class="blue" id="id-company-text">&copy; SarveshWajs.my</h4>
                            </div>
                            ...
                            <div class="position-relative">
                                ...
                                <div align="center" style="color: white;">
                                    © 2021 SarveshWajs Design. All rights reserved v2.0 <br>
                                    Design by <a href="#" target="_blank">SarveshWajs Design</a>
                                </div>
