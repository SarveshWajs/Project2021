				...
				<div class="row">
					...
					<div class="col-md-5">
							<label>
								...
								<span class="lbl"> Featured Product</span>
							</label>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-4 sub_item_code">
						@if(isset($product) && !empty($product->sub_category_id) && !empty($product->category_id))
						{{ isset($product) ? "Item code: ".$product->item_code : '' }}
						@endif
					</div>
				</div>
		...
		<div class="modal-content">
      		...
      		<div class="modal-body">
        		<div class="row">
  					...
  					<div class="form-group" align="center">
						<button class="btn btn-success crop_image">Upload & Crop Image</button>
					</div>
				</div>
      		</div>
