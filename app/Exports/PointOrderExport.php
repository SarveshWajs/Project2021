...
class PointOrderExport implements FromView
{
    /**
...
if(!empty($this->item_code)){
        ...
        return view('backend.reports.download_point_order_report', ['transactions'=>$transactions, 'start'=>$this->start, 'end'=>$this->end,
