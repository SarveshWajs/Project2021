...
class HomeController extends Controller
{
    ...
    public function profile()
    {
      ...
      return view('frontend.profile', ['lvl'=>$lvl, 'totalBalance'=>$totalBalance, 
    ...
    public function wallet()
    {
        ...
        return view('frontend.wallet', [ 'totalBalance'=>$totalBalance, 'withdrawlHistorys'=>$withdrawlHistorys,
                                        'banks'=>$banks, 'banksDefault'=>$banksDefault, 'lvl'=>$lvl], compact('purchaseDetail'));
    }
    ...
    public function GetWalletBalance()
    {
        ...
        $totalBalance =  $withdrawal->totalWithdrawal - $transaction->totalUsedPoint;
    ...
    public function checkout()
    {
        ...
        return view('frontend.checkout', ['carts'=>$carts,  'shipping_address'=>$shipping_address, 'totalBalance'=>$totalBalance, 'banks'=>$banks,
