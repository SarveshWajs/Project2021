...
Route::get('/PointListing', 'HomeController@point_listing')->name('point_listing');
Route::get('/Mall', 'HomeController@mall')->name('mall');
Route::get('/Details/{name}/{id}', 'HomeController@details')->name('details');
Route::get('/PointDetails/{name}/{id}', 'HomeController@point_details')->name('point_details');
...
Route::group(['middleware' => 'auth:admin,merchant,web'], function () {
	...
	Route::get('setting_specific_date', 'Backend\SettingController@setting_specific_date')->name('setting_specific_date');
	Route::post('save_setting_specific_date', 'Backend\SettingController@save_setting_specific_date')->name('save_setting_specific_date');
...
Route::post('/setPointRedemption', 'Backend\AjaxController@setPointRedemption')->name('setPointRedemption');
...
Route::post('/delete_specific_date', 'Backend\AjaxController@delete_specific_date')->name('delete_specific_date');